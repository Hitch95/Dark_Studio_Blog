...
async function createDB() {
    ...
    try {
        ...
        console.log("Avant d'insérer dans la table roles");
        ...
        console.log("Après avoir inséré dans la table roles");

        console.log("Avant d'insérer dans la table roles_id");
        ...
        console.log("Après avoir inséré dans la table roles_id");
