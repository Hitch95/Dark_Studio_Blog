  ...
  try {
    ...
    await connection.query(
      ...
      [
        ...
        'JohnDoe',
        'john@example.com',
        '$2b$10$cwBO9PTBsk7MZNiGi4KxauKgTcsUyxlAcmlQ5tuROtcbEspXb7c2C',
        1,
      ]
    );
    ...
    await connection.query('INSERT INTO roles (id, name) VALUES (?, ?)', [
      adminRoleId,
      'ADMIN',
    ]);
    await connection.query('INSERT INTO roles (id, name) VALUES (?, ?)', [
    ...
    await connection.query(
      'INSERT INTO roles_id(user_id, role_id) VALUES (?, ?)',
      [userId, adminRoleId]
    );
    await connection.query(
      'INSERT INTO roles_id(user_id, role_id) VALUES (?, ?)',
