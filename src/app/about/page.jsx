            ...
            <section className={styles.textContainer}>
                <article className={styles.item}>
                    ...
                    <p className={styles.description}>
                        ...
                        Published by <Link href={"https://github.com/Hitch95"} title="author's github">Hitch95</Link> since 2023, it is aimed at web professionals. 
                        ...
                        Want to write to us? Send an email to the editor using this <Link href={"/contact"} title="contact page">form</Link>.
                    </p>
                </article>
                <article className={styles.item}>
